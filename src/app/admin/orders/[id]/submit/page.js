          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl border border-gray-200 space-y-5">
              <div>
                ...
                <div className="mt-2 px-5 py-4 rounded-lg bg-gray-100 border border-gray-200 text-gray-500 select-none">
                  {order.serialNumber}
                </div>
              </div>
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 space-y-5">
              <div>
                {/* ✅ Label updated to Order Name & layout adjusted for multi-line text */}
                <p className="text-[11px] text-gray-400 uppercase tracking-widest font-semibold">
                  Order Name
                </p>
                <div 
                  style={{ whiteSpace: "pre-line" }} // ✅ Treats \n as visual line breaks
                  className="mt-2 w-full min-h-[60px] px-5 py-4 rounded-lg bg-gray-100 border border-gray-200 text-gray-500 font-medium break-words"
                >
                  {order.title}
                </div>
              </div>
