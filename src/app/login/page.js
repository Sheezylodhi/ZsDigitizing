...
// Separate component for useSearchParams to handle Next.js SSR requirements
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <motion.button
            ...
            className={`w-full cursor-pointer py-4 rounded-xl font-bold shadow-lg transition-all
              ${isLoading ? "bg-gray-400 cursor-not-allowed" : "bg-[#0e2c1c] text-white hover:shadow-2xl"}`}
          >
...
// Main component with Suspense wrapper (Required by Next.js for useSearchParams)
