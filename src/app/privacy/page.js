...
export const metadata = {
  ...
  alternates: {
    canonical: "https://www.zsdigitizing.com/privacy", // Yahan us page ka exact URL hona chahiye
  },
};
    ...
    <div className="flex flex-col min-h-screen w-full bg-gray-50">
      ...
      <main className="flex-grow w-full max-w-5xl px-6 py-28 mx-auto mt-16 lg:mt-20">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10">
          ...
          <h3 className="text-2xl font-semibold mt-8 mb-3">Information We Collect</h3>
          ...
          <h3 className="text-2xl font-semibold mt-8 mb-3">How We Use Your Information</h3>
          ...
          <h3 className="text-2xl font-semibold mt-8 mb-3">Data Protection</h3>
          <p className="text-gray-700 mb-5 leading-relaxed">
          ...
          <h3 className="text-2xl font-semibold mt-8 mb-3">Communication</h3>
          ...
          {/* Refund Policy */}
          <h2 className="text-3xl font-bold text-[#2A4E3B] mb-6">
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Revisions and Adjustments</h3>
          <p className="text-gray-700 mb-5">
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Refund Eligibility</h3>
          <p className="text-gray-700 mb-5">
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Refund Process</h3>
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Digital Delivery</h3>
          <p className="text-gray-700 mb-5">
          ...
          <h3 className="text-xl font-semibold mt-6 mb-3">Turnaround Times</h3>
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Physical Delivery (Optional)</h3>
          <p className="text-gray-700 mb-5">
            We can also provide files via physical delivery such as USB. Shipping charges depend on
            your location and courier service.
          </p>

          <h3 className="text-2xl font-semibold mt-6 mb-3">Delivery Confirmation</h3>
          <p className="text-gray-700 mb-5">
          ...
          <h3 className="text-2xl font-semibold mt-6 mb-3">Customer Support</h3>
