...
export default function PortfolioPage() {
  ...
  useEffect(() => {
    const fetchPortfolio = async () => {
      try {
        const res = await fetch("/api/admin/portfolio"); // Tumhara API route
  ...
  const openModal = (index) => {
    // Current Index ko filtered list ke mutabiq set karna hai
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-24">
      ...
      {/* Modal logic updated to use portfolioItems */}
